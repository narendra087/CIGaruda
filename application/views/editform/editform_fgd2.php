                ...
                <tbody>
                    ...
                    foreach ($pertanyaan as $p){
                        echo "<tr>
                            ...
                            <td ><center>".anchor('editform/edit_fgd/'.$p->id_kuesioner,'<span class="btn btn-info btn-xs"><i class="fa fa-pencil"></i> Edit</span>')."</center></td>
                            <td ><center>".anchor('editform/delete_fgd/'.$p->id_kuesioner,'<span class="btn btn-danger btn-xs"><i class="fa fa-trash-o"></i> Delete </span>')."</center></td>
                            </tr>";
                    }
                    ?>
                  ...
                  <div class="modal fade bs-example-modal-lg" tabindex="-1" role="dialog" aria-hidden="true">
                    <div class="modal-dialog modal-lg">
                      <div class="modal-content">
                        ...
                        <div class="modal-header">
                          ...
                          <?php echo form_open('editform/input_simpan_fgd'); ?>
                        </div>
                        ...
                        <div class="modal-footer">
                          <button type="button" class="btn btn-default" data-dismiss="modal"><?php echo anchor('admin/edit_fgd','KEMBALI');?></button>
                    ...
                    <!-- <button class="btn btn-info btn-sm pull-right aphp " type="button"  data-toggle="tooltip" data-placement="bottom" title="Lihat form">
                         <?php echo anchor('index.php/kuesioner/preview_fgd','Preview <i class="fa fa-eye fa-2x"> </i> '); ?>
                    </button> -->
                    </td> </tr>
                </tbody>
            </table>
