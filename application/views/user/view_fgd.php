      ...
      <div class="row">
        <div class="col-lg-12">
            <div class="x_panel">
                ...
                <div class="x-content">
                    <form method="POST" action="<?php echo base_url();?>cont_fgd/nilai" role="form">
                            ...
                            <tbody>
                              ...
                              <td class="six">
                                  <div class='vertical-align'>
                                    <div class='btns'>
                                      <label>
                                        <input name="<?php echo $id_fgd[$j]->id_kuesioner; ?>" type='radio' value='1'>
                                          <span class='btn first'>Sangat <br>Tidak Setuju</span>
                                        </input>
                                      </label>
                                      <label>
                                        <input name="<?php echo $id_fgd[$j]->id_kuesioner; ?>" type='radio' value='2'>
                                          <span class='btn'>Tidak Setuju</span>
                                        </input>
                                      </label>
                                      <label>
                                        <input name="<?php echo $id_fgd[$j]->id_kuesioner; ?>" type='radio' value='3'>
                                          <span class='btn'>Agak <br>Tidak Setuju</span>
                                        </input>
                                      </label>
                                      <label>
                                        <input name="<?php echo $id_fgd[$j]->id_kuesioner; ?>" type='radio' value='4'>
                                          <span class='btn'>Agak <br> Setuju</span>
                                        </input>
                                      </label>
                                      <label>
                                        <input name="<?php echo $id_fgd[$j]->id_kuesioner; ?>" type='radio' value='5'>
                                          <span class='btn'>Setuju</span>
                                        </input>
                                      </label>
                                      <label>
                                        <input name="<?php echo $id_fgd[$j]->id_kuesioner; ?>" type='radio' value='6'>
