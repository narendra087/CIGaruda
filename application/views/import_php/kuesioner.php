...
$excel->setActiveSheetIndex(0)->setCellValue('B3', "Metode"); // Set kolom C3 dengan tulisan "NAMA"
$excel->setActiveSheetIndex(0)->setCellValue('C3', "Construct"); // Set kolom D3 dengan tulisan "JENIS KELAMIN"
...
$sql = $pdo->prepare("SELECT * FROM tb_pertanyaan where id_metode='kue'");
