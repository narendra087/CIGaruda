...
<<<<<<< HEAD:application/views/admin/dashboard_jktnh.php
...
>>>>>>> 9d3ee7c0d72210d420916676d70a4fe7d772528f:application/views/admin/dashboard_jktnh.php
          ...
          <div class="row">
            <div class="col-md-12 col-sm-12 col-xs-12"> <!-- angka 12 di md san sm itu menentukan panjang cardnya sedangkan 12 di xs lebar cardnya -->
              <div class="dashboard_graph">
                ...
                <div class="">
                  <div class="col-md-6">
                    <h3>Unit HO JKTNH <small></small></h3> <!-- diantara <small> ini bisa di isi teks -->
                  </div>
                </div>
          ...
          <div class="row">
			...
			<div class="col-md-6 col-sm-6 col-xs-12">
                <div class="x_panel">
                  ...
                  <div class="x_content">
                    <div id="graph_barjktnh" style="width:100%; height:280px;"></div>
                  </div>
                </div>
              </div>
              <div class="col-md-6 col-sm-6 col-xs-12">
                <div class="x_panel">
                  ...
                  <div class="x_content">
                    <div id="echart_gaugejktnh" style="height:280px;"></div>
                  </div>
                </div>
              </div>
			 ...
			 <div class="col-md-6 col-sm-6 col-xs-12">
                <div class="x_panel">
                  ...
                  <div class="x_content">
                    <div id="graph_barjktnh2" style="width:100%; height:280px;"></div>
                  </div>
                </div>
              </div>
              <div class="col-md-6 col-sm-6 col-xs-12">
                <div class="x_panel">
                  ...
                  <div class="x_content">
                    <div id="echart_gaugejktnh2" style="height:280px;"></div>
                  </div>
                </div>
              </div>
			 ...
			 <div class="col-md-6 col-sm-6 col-xs-12">
                <div class="x_panel">
                  ...
                  <div class="x_content">
                    <div id="graph_barjktnh3" style="width:100%; height:280px;"></div>
                  </div>
                </div>
              </div>
              <div class="col-md-6 col-sm-6 col-xs-12">
                <div class="x_panel">
                  ...
                  <div class="x_content">
                    <div id="echart_gaugejktnh3" style="height:280px;"></div>
                  </div>
                </div>
              </div>
 ...
 <small>Sessions</small></h2>
                  ...
                  <div class="x_content">
                    <div id="graph_barjktnh4" style="width:100%; height:280px;"></div>
                  </div>
                </div>
              </div>
              <div class="col-md-6 col-sm-6 col-xs-12">
                <div class="x_panel">
                  ...
                  <div class="x_content">
                    <div id="echart_gaugejktnh4" style="height:280px;"></div>
                  </div>
                </div>
              </div>
 ...
 <small>Sessions</small></h2>
                  ...
                  <div class="x_content">
                    <div id="graph_barjktnh5" style="width:100%; height:280px;"></div>
                  </div>
                </div>
              </div>
              <div class="col-md-6 col-sm-6 col-xs-12">
                <div class="x_panel">
                  ...
                  <div class="x_content">
                    <div id="echart_gaugejktnh5" style="height:280px;"></div>
                  </div>
                </div>
              </div>
