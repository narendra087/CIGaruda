...
<script type="text/javascript" src="<?php echo base_url();?>/assets/vendors/echarts/dist/echarts.js"></script>


<script src="<?php echo base_url();?>/assets/chart/corporate.js"   charset="utf-8"></script>
			...
			<div class="col-md-6 col-sm-6 col-xs-12">
              ...
              <div class="col-md-6 col-sm-6 col-xs-12">
                <div class="x_panel">
                  ...
                  <div class="x_content">
                    <div id="gauge" style="height:280px;"></div>
                  </div>
                </div>
              </div>
