          ...
          <div class="row">
            <div class="col-md-12 col-sm-12 col-xs-12"> <!-- angka 12 di md san sm itu menentukan panjang cardnya sedangkan 12 di xs lebar cardnya -->
              <div class="dashboard_graph">
                ...
                <div class="">
                  <div class="col-md-6">
                    <h3>Unit BO Koord SYDAM <small></small></h3> <!-- diantara <small> ini bisa di isi teks -->
                  </div>
                </div>
          ...
          <div class="row">
			...
			<div class="col-md-6 col-sm-6 col-xs-12">
                <div class="x_panel">
                  ...
                  <div class="x_content">
                    <div id="graph_barsydam" style="width:100%; height:280px;"></div>
                  </div>
                </div>
              </div>
              <div class="col-md-6 col-sm-6 col-xs-12">
                <div class="x_panel">
                  ...
                  <div class="x_content">
                    <div id="echart_gaugesydam" style="height:280px;"></div>
                  </div>
                </div>
              </div>
			 ...
			 <div class="col-md-6 col-sm-6 col-xs-12">
                <div class="x_panel">
                  ...
                  <div class="x_content">
                    <div id="graph_barsydam2" style="width:100%; height:280px;"></div>
                  </div>
                </div>
              </div>
              <div class="col-md-6 col-sm-6 col-xs-12">
                <div class="x_panel">
                  ...
                  <div class="x_content">
                    <div id="echart_gaugesydam2" style="height:280px;"></div>
                  </div>
                </div>
              </div>
			 ...
			 <div class="col-md-6 col-sm-6 col-xs-12">
                <div class="x_panel">
                  ...
                  <div class="x_content">
                    <div id="graph_barsydam3" style="width:100%; height:280px;"></div>
                  </div>
                </div>
              </div>
              <div class="col-md-6 col-sm-6 col-xs-12">
                <div class="x_panel">
                  ...
                  <div class="x_content">
                    <div id="echart_gaugesydam3" style="height:280px;"></div>
                  </div>
                </div>
              </div>
			 ...
			 <div class="col-md-6 col-sm-6 col-xs-12">
                <div class="x_panel">
                  ...
                  <div class="x_content">
                    <div id="graph_barsydam4" style="width:100%; height:280px;"></div>
                  </div>
                </div>
              </div>
              <div class="col-md-6 col-sm-6 col-xs-12">
                <div class="x_panel">
                  ...
                  <div class="x_content">
                    <div id="echart_gaugesydam4" style="height:280px;"></div>
                  </div>
                </div>
              </div>
			 ...
			 <div class="col-md-6 col-sm-6 col-xs-12">
                <div class="x_panel">
                  ...
                  <div class="x_content">
                    <div id="graph_barsydam5" style="width:100%; height:280px;"></div>
                  </div>
                </div>
              </div>
              <div class="col-md-6 col-sm-6 col-xs-12">
                <div class="x_panel">
                  ...
                  <div class="x_content">
                    <div id="echart_gaugesydam5" style="height:280px;"></div>
                  </div>
                </div>
              </div>
