          ...
          <div class="row">
            <div class="col-md-12 col-sm-12 col-xs-12"> <!-- angka 12 di md san sm itu menentukan panjang cardnya sedangkan 12 di xs lebar cardnya -->
              <div class="dashboard_graph">
                ...
                <div class="">
                  <div class="col-md-6">
                    <h3>Unit BO Koord SHAAM <small></small></h3> <!-- diantara <small> ini bisa di isi teks -->
                  </div>
                </div>
          ...
          <div class="row">
			...
			<div class="col-md-6 col-sm-6 col-xs-12">
                <div class="x_panel">
                  ...
                  <div class="x_content">
                    <div id="graph_barshaam" style="width:100%; height:280px;"></div>
                  </div>
                </div>
              </div>
              <div class="col-md-6 col-sm-6 col-xs-12">
                <div class="x_panel">
                  ...
                  <div class="x_content">
                    <div id="echart_gaugeshaam" style="height:280px;"></div>
                  </div>
                </div>
              </div>
			 ...
			 <div class="col-md-6 col-sm-6 col-xs-12">
                <div class="x_panel">
                  ...
                  <div class="x_content">
                    <div id="graph_barshaam2" style="width:100%; height:280px;"></div>
                  </div>
                </div>
              </div>
              <div class="col-md-6 col-sm-6 col-xs-12">
                <div class="x_panel">
                  ...
                  <div class="x_content">
                    <div id="echart_gaugeshaam2" style="height:280px;"></div>
                  </div>
                </div>
              </div>
			 ...
			 <div class="col-md-6 col-sm-6 col-xs-12">
                <div class="x_panel">
                  ...
                  <div class="x_content">
                    <div id="graph_barshaam3" style="width:100%; height:280px;"></div>
                  </div>
                </div>
              </div>
              <div class="col-md-6 col-sm-6 col-xs-12">
                <div class="x_panel">
                  ...
                  <div class="x_content">
                    <div id="echart_gaugeshaam3" style="height:280px;"></div>
                  </div>
                </div>
              </div>
			 ...
			 <div class="col-md-6 col-sm-6 col-xs-12">
                <div class="x_panel">
                  ...
                  <div class="x_content">
                    <div id="graph_barshaam4" style="width:100%; height:280px;"></div>
                  </div>
                </div>
              </div>
              <div class="col-md-6 col-sm-6 col-xs-12">
                <div class="x_panel">
                  ...
                  <div class="x_content">
                    <div id="echart_gaugeshaam4" style="height:280px;"></div>
                  </div>
                </div>
              </div>
			 ...
			 <div class="col-md-6 col-sm-6 col-xs-12">
                <div class="x_panel">
                  ...
                  <div class="x_content">
                    <div id="graph_barshaam5" style="width:100%; height:280px;"></div>
                  </div>
                </div>
              </div>
              <div class="col-md-6 col-sm-6 col-xs-12">
                <div class="x_panel">
                  ...
                  <div class="x_content">
                    <div id="echart_gaugeshaam5" style="height:280px;"></div>
                  </div>
                </div>
              </div>
