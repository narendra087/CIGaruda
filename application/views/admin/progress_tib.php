                  ...
                  <div class="x_panel ui-ribbon-container ">
                          <div class="x_content">
                            <!-- <form id="demo-form2" action="<?php echo base_url()?>user/addwarrior/" method="post" data-parsley-validate class="form-horizontal form-label-left" enctype="multipart/form-data">
                              ...
                              <?php $n=0; foreach ($tib as $b) {  $n++; ?>
                              <div class="ln_solid"></div>
                              <h2> Tim Implementasi Budaya <?php echo $n ; ?> </h2> 
                              ...
                              <div class="form-group">
                                ...
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                  <input type="text" id="first-name" name="nama" readonly class="form-control col-md-7 col-xs-12" value="<?php echo $b->nama; ?>">
                                </div>
                              </div>
                                <div class="form-group">
                                ...
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                  <input type="text" id="first-name" name="nama" readonly class="form-control col-md-7 col-xs-12" value="<?php echo $b->posisi; ?>">
                                </div>
                              </div>
                              <div class="form-group">
