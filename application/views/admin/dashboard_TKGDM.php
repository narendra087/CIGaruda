          ...
          <div class="row">
            <div class="col-md-12 col-sm-12 col-xs-12"> <!-- angka 12 di md san sm itu menentukan panjang cardnya sedangkan 12 di xs lebar cardnya -->
              <div class="dashboard_graph">
                ...
                <div class="">
                  <div class="col-md-6">
                    <h3>Turunan Unit BO TKGDM<small></small></h3> <!-- diantara <small> ini bisa di isi teks -->
                  </div>
                </div>
	  ...
	  <div class="col-md-12 col-sm-12 col-xs-12">
			...
			<div class="col-md-6 col-sm-6 col-xs-12">
                <div class="x_panel">
                  ...
                  <div class="x_content">
                    <div id="graph_bartkgdm" style="width:100%; height:280px;"></div>
                  </div>
                </div>
              </div>
              <div class="col-md-6 col-sm-6 col-xs-12">
                <div class="x_panel">
                  ...
                  <div class="x_content">
                    <div id="echart_gaugetkgdm" style="height:280px;"></div>
                  </div>
                </div>
              </div>
...
<small>Sessions</small></h2>
                  ...
                  <div class="x_content">
                    <div id="graph_bartkgdm2" style="width:100%; height:280px;"></div>
                  </div>
                </div>
              </div>
              <div class="col-md-6 col-sm-6 col-xs-12">
                <div class="x_panel">
                  ...
                  <div class="x_content">
                    <div id="echart_gaugetkgdm2" style="height:280px;"></div>
                  </div>
                </div>
              </div>
			 ...
			 <div class="col-md-6 col-sm-6 col-xs-12">
                <div class="x_panel">
                  ...
                  <div class="x_content">
                    <div id="graph_bartkgdm3" style="width:100%; height:280px;"></div>
                  </div>
                </div>
              </div>
              <div class="col-md-6 col-sm-6 col-xs-12">
                <div class="x_panel">
                  ...
                  <div class="x_content">
                    <div id="echart_gaugetkgdm3" style="height:280px;"></div>
                  </div>
                </div>
              </div>
 ...
 <small>Sessions</small></h2>
                  ...
                  <div class="x_content">
                    <div id="graph_bartkgdm4" style="width:100%; height:280px;"></div>
                  </div>
                </div>
              </div>
              <div class="col-md-6 col-sm-6 col-xs-12">
                <div class="x_panel">
                  ...
                  <div class="x_content">
                    <div id="echart_gaugetkgdm4" style="height:280px;"></div>
                  </div>
                </div>
              </div>
 ...
 <small>Sessions</small></h2>
                  ...
                  <div class="x_content">
                    <div id="graph_bartkgdm5" style="width:100%; height:280px;"></div>
                  </div>
                </div>
              </div>
              <div class="col-md-6 col-sm-6 col-xs-12">
                <div class="x_panel">
                  ...
                  <div class="x_content">
                    <div id="echart_gaugetkgdm5" style="height:280px;"></div>
                  </div>
                </div>
              </div>
