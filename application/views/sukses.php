            ...
            <div id="sidebar-menu" class="main_menu_side hidden-print main_menu"> <!-- General Body -->
              <div class="menu_section">
                ...
                <ul class="nav side-menu">
                  <!--Upload-->
                  <li>
                    <a href="<?php echo base_url();?>index.php/isna/dashboard">
                      <i class="fa fa-plane"></i> Dashboard <span class=""></span>
                    </a>
                  </li>
                  <!-- End Upload-->
                  ...
                  <!--Dashboard-->
                  <li>
                    <a href="<?php echo base_url();?>index.php/isna/ideas">
                      <i class="fa fa-home"></i> Ideas <span class="fa"></span>
                    </a>
                  </li>
                  <!-- Dashboard-->
                  ...
                  <!--Ideas -->
                  <li>
                    <a href="<?php echo base_url();?>index.php/arga/form">
                      <i class="fa fa-pencil"></i> Upload File <span class="fa"></span>
                    </a>
                  </li>
                  <!--End Ideas-->
